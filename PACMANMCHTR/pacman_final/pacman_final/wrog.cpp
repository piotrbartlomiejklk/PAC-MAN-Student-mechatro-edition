// wrog.cpp - Implementacje klas WrogLosowy i WrogBFS
// Oba dziedziczą z Wrog (który dziedziczy z ElementyGry).
// Demonstracja polimorfizmu: te same metody (aktualizuj, getTypGrafiki)
// mają RÓŻNE implementacje w każdej klasie pochodnej.
// Gra przechowuje Wrog* i wywołuje aktualizuj() polimorficznie.
